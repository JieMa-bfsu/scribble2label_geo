...
class config:
    ...
    """ Path """
    data_dir = f'./example_re/images/{name}/'
    scr_dir = f'./example_re/labels/{name}/'
    mask_dir = f'./example_re/labels/{name}/'
    df_path = f'./example_re/labels/{name}/train.csv'
    log_dir = f'./logs/{name}100'
    """ Training """
    fold = 0
    n_epochs = 100
    input_size = 256
